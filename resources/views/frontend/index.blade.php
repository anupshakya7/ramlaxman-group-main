 ...
 <!-- Header Start -->
    <section id="home" class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center my-5 py-5">
            <h1 class="text-white mt-4 mb-4">Work <span class="text-warning text-decoration-underline">
                    efficiently
                </span> and
                <span class="text-warning text-decoration-underline">creatively</span>
            </h1>
            <h4 class="text-white mb-5">Ramlaxman Group provides flexible job options as well as the chance to
                strengthen your community while advancing the world economy.</h4>

            <div class="mx-auto mb-5" style="width: 100%; max-width: 600px; display: inline;">

                <button type="button" class="btn btn-light mx-auto rounded-pill py-2 px-4 video-btn"
                    data-bs-toggle="modal" data-src="https://www.youtube.com/embed/fXdlrWuQVW8"
                    ...
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- 16:9 aspect ratio -->
                                <div class="ratio">
                                    <iframe class="embed-responsive-item w-100 " style="height: 550px;" src=""
            ...
            <div class="row">
                ...
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{url('frontend/img/about.jpg')}}" style="object-fit: cover;">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{url('frontend/img/feature.jpg')}}" style="object-fit: cover;">
                    </div>
                </div>

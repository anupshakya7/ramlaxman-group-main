...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar fixed-top navbar-expand-lg bg-white shadow navbar-light py-lg-1 px-lg-5">
            <a href="index.html" class="navbar-brand ml-lg-3">
                <h1 class="m-0 text-uppercase" style="color: #09110e;"><img src="{{url('frontend/img/logo.png')}}" width="60" height="70"
                        alt="logo">
                    RL group</h1>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <a href="/" class="nav-item nav-link">Our Customer</a>
                    <a href="/" class="nav-item nav-link">Contact</a>
                </div>
                <a href="" class="btn btn-primary rounded-pill py-2 px-4 d-none d-lg-block">Join Us</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white mt-4 display-3">Service Detail</h1>
            <div class="d-inline-flex text-white mb-5">
                <h4 class="text-white m-0">We deliver <span class="text-warning">timely, high-quality service</span> to
                    our clients.</h4>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-3">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Service
                                Detail</h6>
                            <h1 style="font-size: 50px;">Web Design & Development</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="{{url('frontend/img/webDesign.jpg')}}" alt="Image">
                        <p>The process of building a website is referred to as web design and development under this
                            general heading. It requires the two key skill sets of web design and web development, as
                            the name would imply. Web design determines the look and feel of a website, while web
                            development determines how it functions.</p>

                        <p>To store and manage all the data that is received through the front end of a website, a back
                            end is required. Therefore, whether a user makes a purchase or completes a form on the front
                            end of the website, they are entering information into an application. And that information
                            is stored in a database that lives on a server.</p>
                    </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-white mb-5 py-3 card shadow rounded-0">
                        <h3 class="text-dark py-3 px-4 m-0">Service Details</h3>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-dark my-3">Available Developer</h6>
                            <h6 class="text-dark my-3">2</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-dark my-3">Client Rating</h6>
                            <h6 class="text-dark my-3">4.5 <small>(250)</small></h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-dark my-3">No of completed Projects</h6>
                            <h6 class="text-dark my-3">15</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-dark my-3">Duration</h6>
                            <h6 class="text-dark my-3">10.00 Hrs</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-dark my-3">Skill level</h6>
                            <h6 class="text-dark my-3">Top Level</h6>
                        </div>
                        <div class="d-flex justify-content-between px-4">
                            <h6 class="text-dark my-3">Language</h6>
                            <h6 class="text-dark my-3">English</h6>
                        </div>
                        <!-- <h5 class="text-dark py-3 px-4 m-0">Course Price: $199</h5> -->
                        <!-- <div class="py-3 px-4">
            ...
            <div class="row">
                <div class="section-title position-relative ">
                    <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Projects
                        Detail</h6>
                    <h1 style="font-size: 50px;">Our Web Projects</h1>
                </div>
                <div class="owl-carousel project-carousel">
                    <div class="courses-item position-relative">
                        <img class="img-fluid" src="{{url('frontend/img/courses-1.jpg')}}" alt="">
                        <div class="courses-text">
                            <h5 class="text-center text-white px-3">GPS Vehicle Tracking System</h5>
                    ...
                    <div class="courses-item position-relative">
                        ...
                        <div class="courses-text">
                            <h5 class="text-center text-white px-3">Web Design & Development</h5>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Jhon Doe</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
                    ...
                    <div class="courses-item position-relative">
                        ...
                        <div class="courses-text">
                            <h5 class="text-center text-white px-3">Mobile Application Development</h5>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Jhon Doe</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
                    ...
                    <div class="courses-item position-relative">
                        ...
                        <div class="courses-text">
                            <h5 class="text-center text-white px-3">Graphics & Creative Designing</h5>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Jhon Doe</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
                    ...
                    <div class="courses-item position-relative">
                        ...
                        <div class="courses-text">
                            <h5 class="text-center text-white px-3">Logo Design</h5>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Jhon Doe</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
                    ...
                    <div class="courses-item position-relative">
                        ...
                        <div class="courses-text">
                            <h5 class="text-center text-white px-3">Id & vCard Design</h5>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Jhon Doe</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
